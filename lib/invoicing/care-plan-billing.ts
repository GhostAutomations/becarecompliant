 ...
 * Thu..Sun on the new plan), each segment its own dated line group. Amounts are quantity times
 * the printed unit price, so every line on the finished invoice multiplies out (Phil,
 * 2026-08-01).
 */
