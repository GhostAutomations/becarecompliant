-- 0014_rename_annual_appraisal
-- Rename the Appraisal check to "Annual Appraisal" (record + Settings display).
-- The register keeps the "AA" column abbreviation. Applied to ref bgrtcvyjuwopunpnudeu only.

update public.check_definitions set name = 'Annual Appraisal'
  where population = 'people' and key = 'appraisal';
