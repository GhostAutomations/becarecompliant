...
- [ ] E4q. RECORD ONLY WHAT IS BOOKED (Phil, 2026-07-12): the Record meeting button only appears when the person has a booked-in meeting (open, not declined); its Meeting Type never offers unbooked stages. No booking = no Record meeting.
