  ...
  return (
    <div className="w-full space-y-3">
      ...
      {/*
        ...
        The score, every figure and the urgent follow ups are all cells in the same grid, and
      ...
      <div className="dash-grid">
        ...
        {/* Ten columns, not four equal ones. A tile holding a number and four words does
          ...
          {/*
            ...
            */}
          {/*
            THE TWO WRAPPERS THAT USED TO BE HERE ARE GONE. One was a nine twelfths column, the
            other a flex-wrap with a 19rem floor per tile and [&>*]:h-auto to undo the stretching
